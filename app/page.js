        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <Link href="/" className="flex items-center py-2 px-3 font-bold text-xl">
                AutoTransporter
              </Link>
              <div className="hidden md:flex items-center space-x-3">
                <Link href="/marketplace" className="py-2 px-3 hover:underline">Marketplace</Link>
                <Link href="/services" className="py-2 px-3 hover:underline">Services</Link>
                <Link href="/contact" className="py-2 px-3 hover:underline">Contact</Link>
              </div>
            </div>
            <div className="hidden md:flex items-center space-x-2">
              <Link href="/login" className="py-2 px-4 bg-blue-500 hover:bg-blue-600 text-white rounded">Login</Link>
              <Link href="/signup" className="py-2 px-4 bg-green-500 hover:bg-green-600 text-white rounded">Sign Up</Link>
            </div>
          </div>
        </div>
      </nav>
